...
import javax.swing.border.LineBorder;
	...
	public class Election_system<E> implements ActionListener {
		JFrame f1,f2,f3,f4,f5,f6,f7,f8;
		JLabel l, l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24,l25,l26,l27,l28,l29,l30,l31;
        ...
        //Admin authorities
        {
            ...
            f5.setLayout(null);
           // f5.setIconImage(logo.getImage());
            
            l31 = new JLabel();
	        ImageIcon i2 = new ImageIcon("E:\\java\\semester project\\src\\New folder\\Screenshot 2023-05-23 200418.png");
	        Image originalImage1 = i2.getImage();
	        Image scaledImage1 = originalImage1.getScaledInstance(100, 100, Image.SCALE_SMOOTH);
	        i2 = new ImageIcon(scaledImage1);
	        l31.setIcon(i2);
	        l31.setOpaque(true);
	        l31.setVisible(true);
	        l31.setBounds(70, 200, 100, 100);
	        f5.add(l31);
            
            b13=new JButton("START");
            b13.setBounds(50,200,180,30);
